...
DOWNLOADER_SCRIPT="/mnt/big/system/scripts/putio-downloader.sh"
SORTER_SCRIPT="/mnt/big/system/scripts/filebot-organizer.sh"
...
DOWNLOADER_LOG_DIR="/mnt/big/system/logs/putio-downloader"
SORTER_LOG_DIR="/mnt/big/system/logs/filebot-organizer"
CURRENT_TIME=$(date +%s)
